...
let    htmlstream = '';
     ...
     if (req.session.auth && req.session.admin) {  // 만약, 관리자가 로그인했다면
       ...
       htmlstream = htmlstream + fs.readFileSync(__dirname + '/../views/mainnavbar.ejs','utf8');  // 일반사용자메뉴
       htmlstream = htmlstream + fs.readFileSync(__dirname + '/../views/maincontent.ejs','utf8'); // Content
     }
